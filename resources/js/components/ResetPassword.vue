                ...
                <div class="card">
                    ...
                    <div class="card-body p-sm-4">
                        <div class="row gy-3 g-sm-4">
                            <div class="col-12">
                                <input type="email" class="form-control bg-body-secondary" minlength="1" maxlength="255"
                                    id="email" placeholder="E-mail address" required v-model.trim="email"
                                    v-on:keyup.enter="">
                            </div>
                            <div class="col-12">
                                <button type="button" v-on:click="" class="btn btn-success w-100" :disabled="1 == 2"
                                    v-text="1 == 2 ? 'Please wait...' :
                                    'Continue'"></button>
                            </div>
                        </div>
                    </div>
